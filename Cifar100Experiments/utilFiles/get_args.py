...
def the_args():
    ...
    parser.add_argument(
        "--exp_id", type=str,  default="ID",
    )
    parser.add_argument(
        "--kl_strength", type=float,  default=0.01, help = "KL regularization strength."
    )
    parser.add_argument(
    ...
    args.exp_save_name = f"NEWREG_{args.exp_id}_{args.net}_net_{args.b}_bs_{args.lr}_lr_200Ep"
